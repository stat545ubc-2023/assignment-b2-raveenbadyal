...
## Contents
- The README.Rmd file (this file) gives an overview of the repository for Assignment B1.
...
- The rbpack folder contains the following files that were generated when creating the rbpack package:
